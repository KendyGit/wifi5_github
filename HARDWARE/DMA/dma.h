...
extern u8 APP_Control_Override; //Override??app???? 
extern u8 APP_Control_Override_Auger; //Override??app????????
extern u8 APP_Control_Override_Fan; //Override??app????????
extern u16 APP_Control_Override_RTD; //Override??app,??RTD??
extern u8 APP_Display_Override; //???Override??app???? 
extern u8 APP_Display_RTD[3];
extern u8 APP_Control_Override_flag;
